...
# rm local_output -r
# CUDA_VISIBLE_DEVICES=$SELECTED_GPU torchrun train.py --depth=16 --bs=32 --ep=2000 --fp16=1 --alng=1e-3 --wpe=0.1 --data_path=data/ #--master_addr=127.0.0.1 --master_port=29500 --nnodes=1 --node_rank=0 --nproc_per_node=8
