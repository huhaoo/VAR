...
# rm local_output -r
rm nohup.out
CUDA_VISIBLE_DEVICES=$SELECTED_GPU nohup torchrun train.py --depth=16 --bs=32 --ep=200 --fp16=1 --alng=1e-3 --wpe=0.1 --data_path=data/ --tblr=4.167e-06 & #--master_addr=127.0.0.1 --master_port=29500 --nnodes=1 --node_rank=0 --nproc_per_node=8
